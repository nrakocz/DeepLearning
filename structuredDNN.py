...
class LRFinder(Callback):
    ...
    '''
    A callback for finding the optimal learning rate range for your model + dataset. 
    
    # Usage
        mixedInputModel.lr_finder()
        mixedInputModel.lr_finder.plot_lr()
    
    # Arguments
        min_lr: The lower bound of the learning rate range for the experiment.
        max_lr: The upper bound of the learning rate range for the experiment.
        tr_sample_size: number of asmples in data-set
        epochs: Number of epochs to run experiment. Usually 1. 
    ...
    def __init__(self,
        ...
        steps_per_epoch=np.ceil(tr_sample_size/batch_size) # Number of mini-batches in the dataset.
